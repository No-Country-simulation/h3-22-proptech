...
/*
        <div className="bg-green-100 border flex justify-between border-green-400 text-green-700 px-4 py-6 rounded relative">
          <span className="block sm:inline font-inter">
            Tu Documentación ha sido aprobada. ¡Ya puedes invertir en nuestra plataforma!
          </span>
          <button className="ml-4 px-4 py-2 bg-[#396AD3] text-white rounded-md text-sm font-inter">
            Invertir Ahora
          </button>
