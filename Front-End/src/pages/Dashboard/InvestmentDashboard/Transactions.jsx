      ...
      <div className="p-14 ml-8 flex flex-col gap-5">
        ...
        <div className="flex gap-8 ">
          <div className="h-44 w-72 rounded-md border border-[#D1D1D1] p-4 flex flex-col gap-4">
            <h3 className="text-xl font-bold font-inter">Total de Invertido</h3>
            <p className="text-2xl font-semibold font-inter">$10.000</p>
          </div>

          <div className="h-44 w-72 rounded-md border border-[#D1D1D1] p-4 flex flex-col gap-4">
            <h3 className="text-xl font-bold font-inter">Total Retirado</h3>
        ...
        <div className="flex justify-between">
          ...
          <button className="px-4 rounded-md py-2 bg-[#396AD3] text-white font-inter">
            Descargar Resumen
          </button>
        </div>
        <div>
